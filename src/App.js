...
const App = () => {
  ...
  const [aliveRicks, setAliveRicks] = useState();
  const [aliveMortys, setAliveMortys] = useState();
  ...
  useEffect(() => {
    ...
    .then(res => {
      setAliveMortys (res.data.info.count);
    })
    }, [])    
  ...
  return (
    <div className="App">
      ...
      <OverallTracker aliveRicks={aliveRicks} aliveMortys={aliveMortys} />
